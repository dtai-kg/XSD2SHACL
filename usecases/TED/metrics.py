...
F = set()
F.add(URIRef("http://data.europa.eu/a4g/ontology#CompetitionNotice"))
F.add(URIRef("http://data.europa.eu/a4g/ontology#PlanningNotice"))
F.add(URIRef("http://data.europa.eu/a4g/ontology#Business"))
F.add(URIRef("http://data.europa.eu/a4g/ontology#ContractAwardNotice"))
...
for case in ["F03","F06","F13"]:
    ...
    num_gt, num_pd, inRML, pd_inRML = metric.target_declaration_coverage_score(F)
